...
import cn.panda.client.exception.JobSubmitProtectException;
...
//        this.acquireTimeout = appContext.getConfig().getParameter(ExtConfig
// .JOB_SUBMIT_LOCK_ACQUIRE_TIMEOUT, 100);
//
...
//                .JOB_SUBMIT_LOCK_ACQUIRE_TIMEOUT, 100);
    ...
    public Response execute(final List<Job> jobs, final JobSubmitExecutor<Response>
            jobSubmitExecutor) throws JobSubmitException {
