...
public class HBaseQueryV2 {
	...
	private static final String INSERT_UPDATE_SCHEMA = "retail_fas_db.inventory_financial_book.1.avsc";
//	private static final String INSERT_UPDATE_SCHEMA = "F:/DC_PROJECT/dataCenter_workspace/dc-cdc-plugin-0.1.0/src/test/java/cn/wonhigh/dc/cdc/plugin/testarchi/archi/retail_fas_db.gms_period_balance1.1.avsc";
	private static final String DELETE_SCHEMA = "delete_binlog.1.avsc";
//	private static final String DELETE_SCHEMA = "F:/DC_PROJECT/dataCenter_workspace/dc-cdc-plugin-0.1.0/src/test/java/cn/wonhigh/dc/cdc/plugin/testarchi/archi/delete_binlog.1.avsc";
	
	//hbase里操作的表
	public static final String TABLE = "transaction_history_dev";
//	/*
//	 * sql 列表
//	 */
...
//			admin.deleteTable(table);
	...
	public void hbaseCrud(String tableName, byte[] startRowKey, byte[] endRowKey, String insertUpdateSchema) throws Exception {
		Connection conn = null;
		Table table = null;
		...
		try {
			...
			for (Result result : results) {
				...
				System.out.println("dmlType: " + dmlType);
...
//					schema = parser.parse(getClass().getResourceAsStream("/conf/"+ DELETE_SCHEMA));
//
//				} else {
////					schema = parser.parse(getClass().getResourceAsStream(this.INSERT_UPDATE_SCHEMA));
//					schema = parser.parse(getClass().getResourceAsStream("/conf/"+insertUpdateSchema));
//				}
...
//				}
	...
	private void printRows(List<Record> records, int rowSize, Schema schema) throws Exception {
...
//	private void query(Map<String, Object> map) throws Exception, SQLException {
//
//		String sql = "select * from retail_fas_db.inventory_financial_book";
//		ResultSet resultSet = MysqlUtil.excuteQuery(SqlLoader.getMysqConnection(), sql);
//
//
...
//	}
	...
	//        return null;
	//    }
	public List<Record> decodeDataumAvro(byte[] input, Schema schema, int rowSize) throws Exception {
		ByteArrayInputStream bis = null;
		GenericDatumReader<Record> reader;
...
//	public List<String> loadSqlFile(String sqlFilePath){
//		return SqlLoader.readSqlFile(sqlFilePath);
//	}
